...
**SPACE**
Developer productivity across five areas:
...
- [ ] Subscriptions
- [ ] Operating effort (people and time)
- [ ] Other: _______________
...
*We will go through this together and put names against each item.*

| Data needed | Owner | How hard to get? | Notes |
|-------------|-------|-----------------|-------|
| Cluster inventory | | | |
...
| Tooling list | | | |
| Ops effort estimate | | | |
| Production app list / top 20 | | | |

---

## Section 4 — Ways of working

*Confirm these in the session and note the details below.*
...
| Baseline | The current state — what things cost today |
