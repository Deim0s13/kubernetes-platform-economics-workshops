...
|---------|------|-------------|
| v1.0 | [DATE] | First-pass showback built — Workshop 3 |
...
> Carry forward from the Assumptions Register — Section 3

| Rule | Decision applied |
|------|----------------|
| Shared platform costs | [CARRY FORWARD FROM assumptions-register.md] |
| Platform tooling | [CARRY FORWARD FROM assumptions-register.md] |
| Operating effort | [CARRY FORWARD FROM assumptions-register.md] |
| Tagging standard used | [CARRY FORWARD FROM assumptions-register.md] |
...
| Team or namespace | Compute | Tooling | Ops effort | Shared services | Total | % of total | Confidence |
|------------------|---------|---------|------------|-----------------|-------|------------|------------|
| [TEAM / NS A] | | | | | | | H / M / L |
| [TEAM / NS B] | | | | | | | H / M / L |
| [TEAM / NS C] | | | | | | | H / M / L |
...
## Showback by environment

> Production versus non-production split

| Environment | Monthly total | Annual total | % of total | Confidence | Notes |
|-------------|--------------|-------------|------------|------------|-------|
| Production | | | | H / M / L | |
| Non-production | | | | H / M / L | |
| **Total** | | | 100% | | |
...
> Costs that could not be attributed to a team or namespace

| Cost item | Amount | Reason not allocated | Plan to allocate |
|-----------|--------|---------------------|-----------------|
| | | | |
| **Total unallocated** | | | |

**Unallocated as % of total:** _______%
...
**Unexpected concentrations of spend:**

```
Notes:
```

**Tagging or allocation gaps identified:**

```
Notes — flag as quick wins in the 90-day plan
```
